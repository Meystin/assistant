  ...
  xfs.mkdir(p, mode, function(er) {
    ...
    switch (er.code) {
      case "ENOENT":
        ...
        mkdirP(path$4.dirname(p), opts, function(er2, made2) {
          if (er2) cb(er2, made2);
...
function requireSync() {
  if (hasRequiredSync) return sync2;
  hasRequiredSync = 1;
  sync2 = globSync;
  ...
  GlobSync.prototype._finish = function() {
    ...
    if (this.realpath) {
      ...
      this.matches.forEach(function(matchset, index) {
        var set2 = self.matches[index] = /* @__PURE__ */ Object.create(null);
...
function getElectronPath() {
  ...
  if (define_process_env_default.ELECTRON_OVERRIDE_DIST_PATH) {
    return path$2.join(define_process_env_default.ELECTRON_OVERRIDE_DIST_PATH, executablePath || "electron");
  }
  if (executablePath) {
...
function getElectronFullPath(filePath) {
  return path$1.join(userData, filePath);
}
...
const storage = /* @__PURE__ */ getDefaultExportFromCjs(dist);
